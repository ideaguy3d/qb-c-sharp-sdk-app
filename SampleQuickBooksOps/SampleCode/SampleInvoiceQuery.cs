...
{
    public class SampleInvoiceQuery
    {
        ...
        void BuildInvoiceQueryRq(XmlDocument doc, XmlElement parent)
        {
            ...
            if (ORElementType == "nothing")
            {
                ...
                if (ORElementType == "ModifiedDateRangeFilter")
                {
                    ...
                    ModifiedDateRangeFilter.AppendChild(MakeSimpleElem(doc, "FromModifiedDate",
                        "2007-12-15T12:15:12-08:00"));
                    //Set field value for ToModifiedDate <!-- optional -->
                    ModifiedDateRangeFilter.AppendChild(MakeSimpleElem(doc, "ToModifiedDate",
                        "2007-12-15T12:15:12-08:00"));
